...
Most of these come down to network reality or how inaturalist serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

inaturalist rate-limits like any public site. inaturalist already paces
...
Where a surface is gated, inaturalist reads a cookie or token you supply
...
`inaturalist`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what inaturalist actually did
