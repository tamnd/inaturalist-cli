...
```
inaturalist <command> [arguments] [flags]
```

Run `inaturalist <command> --help` for the full flag list on any command. This
...
per operation you declare in `inaturalist/domain.go`.
