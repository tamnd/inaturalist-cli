---
title: "inaturalist"
description: "Browse iNaturalist nature observations from the terminal"
heroTitle: "inaturalist, from the command line"
heroLead: "Browse iNaturalist nature observations from the terminal One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
inaturalist links <path>           # the pages it links to, each addressable
inaturalist serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading inaturalist by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address inaturalist as
  `inaturalist://` URIs and follow links across sites. See
