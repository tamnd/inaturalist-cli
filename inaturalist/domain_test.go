...
// HTTP behaviour is covered in inaturalist_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "inaturalist://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("inaturalist", "about")
	if err != nil || got.String() != "inaturalist://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want inaturalist://page/about", got.String(), err)
	}
}
